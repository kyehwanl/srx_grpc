...
Requires(pre): srxcryptoapi >= 0.2.0 srxcryptoapi < 0.3.0, srx-proxy >= 0.4.0, srx-proxy < 0.5.1
Requires: glibc >= 2.12, readline >= 6.0, srx-proxy >= 0.4.0, srx-proxy < 0.5.1, srxcryptoapi >= 0.2.0, srxcryptoapi < 0.3.0
...
--disable-babeld \
sca_dir=/opt/project/srx_test1/srx/../_inst/ srx_dir=/opt/project/gobgp_test/gowork/src/srx_grpc/srx/test_install
#sca_dir= srx_dir=
